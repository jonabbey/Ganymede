 ...
 *
 * <P>The {@link arlut.csd.ddroid.server.DBStore DBStore} contains a tree of 
 * {@link arlut.csd.ddroid.rmi.CategoryNode CategoryNode}s, each of which is either
 * a {@link arlut.csd.ddroid.server.DBObjectBase DBObjectBase} or a DBBaseCategory.  The
 * {@link arlut.csd.ddroid.rmi.Category Category} RMI interface is used by the
...
public class DBBaseCategory extends UnicastRemoteObject implements Category, CategoryNode {
   ...
   * a {@link arlut.csd.ddroid.server.DBObjectBase DBObjectBase} or another
   * {@link arlut.csd.ddroid.server.DBBaseCategory DBBaseCategory}.
   */
   ...
   * (both {@link arlut.csd.ddroid.server.DBObjectBase DBObjectBase} objects
   * and contained {@link arlut.csd.ddroid.server.DBBaseCategory DBBaseCategory}
   ...
   * {@link arlut.csd.ddroid.server.DBStore#printCategoryTreeHTML(java.io.PrintWriter)
   ...
   *
   * @param session The {@link arlut.csd.ddroid.server.GanymedeSession
   * GanymedeSession} that we consult to determine the permissions to
   * be encoded in the returned {@link arlut.csd.ddroid.common.CategoryTransport CategoryTransport}.
   * 
   ...
   * client.
   *
   * @see arlut.csd.ddroid.server.GanymedeSession
   */
   ...
   * {@link arlut.csd.ddroid.common.CategoryTransport CategoryTransport} object for serialization to
   * the client.</p>
   *
   * <p>This is kind of icky code, really.. {@link arlut.csd.ddroid.server.DBBaseCategory DBBaseCategory},
   * {@link arlut.csd.ddroid.server.DBObjectBase DBObjectBase}, {@link arlut.csd.ddroid.server.GanymedeSession GanymedeSession}
   * and {@link arlut.csd.ddroid.common.CategoryTransport CategoryTransport}
   ...
   * {@link arlut.csd.ddroid.server.DBObjectBase#addBaseToTransport(arlut.csd.ddroid.common.CategoryTransport,
   * arlut.csd.ddroid.server.GanymedeSession)}.</p>
   */
  ...
  /**
   * <p>Returns true if this category contains any bases editable by the given {@link arlut.csd.ddroid.server.GanymedeSession session}.
  ...
  /**
   * <p>Returns true if this category contains any bases visible by the given {@link arlut.csd.ddroid.server.GanymedeSession session}.
   * If session is null, we're supergash, so of course this category is going to contain
   * a visible base.
   */
   ...
   * contains a {@link arlut.csd.ddroid.rmi.CategoryNode CategoryNode}
   * with name &lt;name&gt;</p>
   */
