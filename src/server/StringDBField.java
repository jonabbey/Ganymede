/*
   ...
   Last Mod Date: $Date: 2000/08/22 06:43:50 $
	...
	if (proxyClass == null)
	  {
	    ...
	    try
	      {
		proxyClass = Class.forName("arlut.csd.ganymede.string_fieldRemote");
	      }
	    catch (ClassNotFoundException ex)
	      {
		System.err.println("DBField.getProxy(): couldn't find arlut.csd.ganymede.string_fieldRemote");
		ex.printStackTrace();
