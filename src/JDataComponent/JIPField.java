...
public class JIPField extends JentryField {
 ...
 // JIPField methods
  ...
  /**
   *  sets the JIPField to a specific value
   *
   * @param str value to which the JIPField is set
   */
  ...
  /**
   *  assigns a set of characters which are valid within the JIPField
   *
  ...
  /**
   *  assigns a set of characters which are invalid within the JIPField
   *
  ...
  /**
   * returns the maximum size of the string that can be placed in this JIPField
   */
