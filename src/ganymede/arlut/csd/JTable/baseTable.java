...
public class baseTable extends JComponent implements AdjustmentListener, ActionListener, MouseWheelListener {
  ...
  /**
   * <p>Converts a preference String returned by getColumnsPref() to
   * an int array encoding the column widths, suitable for passing to
   * the baseTable constructor.</p>
   *
   * @param prefString A String generated by getColumnsPref() that
   * encodes the width/position of the columns in this table.
   *
   * @return An int array that can be used as the colWidths parameter
   * to a JTable constructor.
   */

  public static int[] decodeColumnsPref(String prefString)
  {
    String[] cols = prefString.split(":");
    ...
    for (int i = 0; i < cols.length; i++)
      {
        try
          {
            colWidths[i] = Integer.parseInt(cols[i]);
          }
  ...
  /**
   * <p>Returns the width/position of the columns as a preference
   * String.</p>
   *
   * <p>The returned String can be converted back into a int[] of
   * colWidths by the static {@link
   * arlut.csd.JTable.baseTable#decodeColumnsPref(java.lang.String)
   * decodeColumnsPref()} method.</p>
   *
   * @return a String that encodes the width (and hence position) of
   * each column in this table.
   */

  public String getColumnsPref()
  {
  ...
  /**
   * <p>This method returns the first line of the display area, below
   * the headers.</p>
   */
  ...
  /**
   * <p>This method is used to recalculate the vertical position of
   * all of the rows in the table below startRow.  If startRow is 0,
   * all rows will be readjusted.</p>
   *
   * <p>This method is provided to support variable-height rows.</p>
   */
  ...
  /**
   * <p>This method returns a Vector of Strings containing the titles
   * of columns currently in the table.</p>
   */
   ...
   * <p>Internal method</p>
   *
   * <p>This method recalculates the general parameters of our table's
   * display.  That is, it calculates whether or not we need scroll
   * bars, adds or deletes the scroll bars, and scales the column
   * positions to match the general rendering parameters.</p>
   */
   ...
   * <p>Internal method</p>
   *
   * <p>Check to see whether we need scrollbars in our current
   * component size, set the min/max/visible parameters</p>
   *
   * <p>This method is intended to be called from reShape().</p>
   */
   ...
   * <p>Internal method</p>
   *
   * <p>Calculate the total vertical size of the rows only</p>
   */
   ...
   * <p>Internal method</p>
   *
   * <p>Calculate our columns.  This method is called both by
   * reShape() and by our canvas, in response to the user adjusting
   * the columns by hand.</p>
   */
   ...
   * <p>Internal method</p>
   *
   * <p>Calculate our fonts and measurements.  If they have changed,
   * go ahead and reshape ourselves.</p>
   */
