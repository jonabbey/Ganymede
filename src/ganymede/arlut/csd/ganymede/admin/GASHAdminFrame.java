    ...
    if (splitterPos != -1)
      {
        ...
        dim = statusBox.getPreferredSize();
        ...
        if (dim == null)
          ...
          {
            System.err.println("statusBox preferred size is " + dim);
          }

        dim = statusBox.getSize();
        ...
        if (dim == null)
          ...
          {
            System.err.println("statusBox size is " + dim);
          }

        dim = tabPane.getPreferredSize();
        ...
        if (dim == null)
          ...
          {
            System.err.println("tabPane preferred size is " + dim);
          }
        ...
        if (dim == null)
          ...
          {
            System.err.println("tabPane size is " + dim);
          }
