...
/**
 * <p>Logical OR node for use in a serialized {@link
 * arlut.csd.ganymede.common.Query Query} object's {@link
 * arlut.csd.ganymede.common.QueryNode QueryNode} tree.</p>
 */
...
public class QueryOrNode extends QueryNode {
  ...
  {
    return "(" + child1.toString(query) + ") OR (" + child2.toString(query) + ")";
  }
}
