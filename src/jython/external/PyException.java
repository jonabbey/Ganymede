...
public class PyException extends RuntimeException
{
     ...
     */
    transient public PyObject type;

    /**
     * The exception instance (for class exception) or exception
     * value (for string exception).
     */
    transient public PyObject value = Py.None;

    transient public PyTraceback traceback;
    ...
    public PyException(PyObject type, PyObject value) {
        ...
        this.stackTraceString = this.toString();
    }
        ...
        if (printingStackTrace) {
            ...
            try {
                ...
                if ((type == null) || (value == null) || (traceback == null)) {
                    s.println(this.stackTraceString);
                    s.flush();
                }
                else {
