/*
   ...
   Last Mod Date: $Date: 1999/01/22 18:04:33 $
	...
	if (operation == SETVAL)
	  {
	    ...
	    result = invf.createNewEmbedded(true);

	    if (result == null)
	      {
		return Ganymede.createErrorDialog("Couldn't create embedded volume",
						  "Error in the Ganymede userCustom object code?");
	      }
