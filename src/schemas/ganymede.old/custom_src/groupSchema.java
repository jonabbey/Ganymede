/*
   ...
   Last Mod Date: $Date: 1999/01/22 18:04:28 $
...
public interface groupSchema {
  ...
  // field id's for the group object.  These should match the current
  // specs in the Ganymede schema file precisely.  If you change the
  // schema for the group, you'll want to change this file to match.
